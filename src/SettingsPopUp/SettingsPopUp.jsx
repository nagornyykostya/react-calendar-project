...
class SettingsPopUp extends Component {
    ...
    return (
        <div className="header__settings-modal">
                <button className="header__close-modal-btn" id="close-modal-btn" title="Close" onClick={() => handleSettingsShow()}><i
                ...
                <form className="header__settings-form">
                    <div className="header__settings-configes">
                        ...
                        <input className="header__color-input" type="color" id="base-color" name="base-color" onChange={(e) => this.handleColorChange(e)} value={this.state.defaultColor} />
                    </div>
                    <button className="header__submit-btn" type="submit" onClick={(e) => this.handleSaveColor(e)}>Save</button>
                </form>
            </div>
    )
}
