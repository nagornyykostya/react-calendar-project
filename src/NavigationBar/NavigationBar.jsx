...
class NavigationBar extends Component {
  ...
  handleWeekChange = (event) => {
    ...
    if (direction) {
      this.props.setCurrentWeekStart(
        this.props.currentWeekStart + 7 * miliSecondsPerDay
      );
    } else {
      this.props.setCurrentWeekStart(
        this.props.currentWeekStart - 7 * miliSecondsPerDay
    ...
    return (
      <header className="header">
        ...
        <div className="weeks-selectors-block">
          <button
            className="weeks-selectors-block__previous-week"
            title="Previous week"
          ...
          <button
            className="weeks-selectors-block__next-week"
            title="Next week"
            data-direction="true"
            onClick={(e) => this.handleWeekChange(e)}
          >
        ...
        {this.state.isSettingsOpen && (
          <SettingsPopUp
            ...
            handleSettingsShow={this.handleSettingsShow}
